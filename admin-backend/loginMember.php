    ...
    <div class="col-md-4">
      ...
      <div class="" ng-if="userInfo">
        ...
        <div class="">
          ...
          <div class="form-check form-check-inline mt-2">
            <input ng-model="gender" class="form-check-input" type="radio" name="gender" id="inlineRadio1" value="1">
            <label class="form-check-label" for="inlineRadio1">Male</label>
          </div>
          <div class="form-check form-check-inline">
            <input ng-model="gender" class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="2">
            <label class="form-check-label" for="inlineRadio2">Female</label>
          </div>
          <div class="form-check form-check-inline">
            <input ng-model="gender" class="form-check-input" type="radio" name="gender" id="inlineRadio2" value="3">
          ...
          <div class="form-control form-control-lg border border-1 border-black rounded rounded-4 mt-2" style="width:81vh;">
            <div class="row" style="width:81vh;">
              <div class="col "> <label for="">Choose your partner min ages</label>
                <select name="" id="" ng-model="minAges" ng-change="changeMinAge()">
              ...
              <div class="col "> <label for="">Choose your partner max ages</label>
                <select name="" id="" ng-model="maxAges" ng-change="changeMaxAge()">
          ...
          <div class="border">
            ...
            <div class="form-check form-check-inline mt-2">
              <input class="form-check-input" type="radio" name="pMale" id="inlineRadio1" value="0">
              <label class="form-check-label" for="male">Male</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="pFemale" id="inlineRadio2" value="1">
              <label class="form-check-label" for="female">Female</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" name="pBoth" id="inlineRadio2" value="2">
          ...
          <div class="row">
            <div class="col-md-4" ng-repeat="hobby in hobbies">
              <div class="form-check form-check-inline">
                ...
                <label for="hobby-{{hobby.id}}" type="checkbox" value="hobby-{{hobby.id}}" name="" id="" class="form-check-label">{{ hobby.name }}
              </div>
      ...
      <div ng-if="userPhoto" class="">
        ...
        <div class="container">
          ...
          <input type="file" name="" id="uploaD1" style="display: none;" onchange="fileUpload('1')">
          <input type="file" name="" id="uploaD2" style="display: none;" onchange="fileUpload('2')">
          <input type="file" name="" id="uploaD3" style="display: none;" onchange="fileUpload('3')">
          <input type="file" name="" id="uploaD4" style="display: none;" onchange="fileUpload('4')">
          <input type="file" name="" id="uploaD5" style="display: none;" onchange="fileUpload('5')">
          <input type="file" name="" id="uploaD6" style="display: none;" onchange="fileUpload('6')">
        </div>
        <!--  -->
      </div>
...
<script>
  ...
  //   if (!allowedTypes.includes(file.type) || !['jpeg', 'jpg', 'png'].includes(fileExtension)) {
  //     alert('Please select a valid image file (JPEG/JPG/PNG).');
